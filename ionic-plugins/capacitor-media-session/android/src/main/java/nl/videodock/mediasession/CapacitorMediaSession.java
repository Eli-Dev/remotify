...
public class CapacitorMediaSession {
    ...
    private MediaSessionVolume mMediaSessionVolume;

    public void initMediaSession(Context context, JSObject params, OnMediaSessionEventListener listener) {
        mMediaSession = new MediaSessionCompat(context, "CapacitorMediaSession");
        mMediaSessionCallback = new MediaSessionCallback();
        mMediaSessionVolume = new MediaSessionVolume();
        ...
        mMediaSessionVolume.setMediaSessionEventListener(listener);
        mMediaSession.setPlaybackToRemote(mMediaSessionVolume);
